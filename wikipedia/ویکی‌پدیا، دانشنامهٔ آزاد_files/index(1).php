...
return HTML_CHAR_MAP[ch];
	...
	if(mw.config.get('wgUserNewMsgRevisionId') != null)
	{
		...
		orangeBarDiv.innerHTML = 'شما از یک کاربر دیگر <a href="/wiki/User_talk:' + encodeURIComponent(wgUserName) + '" title="User talk:'+escapeHtml(wgUserName)+'">پیام‌ جدید دارید</a> (<a href="/w/index.php?title=User_talk:'+encodeURIComponent(wgUserName)+'&diff=cur&old='+wgUserNewMsgRevisionId+'">۱ تغییر اخیر</a>).';
